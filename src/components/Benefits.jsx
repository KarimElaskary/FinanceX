  ...
  return (
    <div className='flex flex-col md:flex-row container mx-auto mt-[150px] justify-between'>
      <div className='flex flex-col'>
        <h1 className='font-Rubik font-semibold text-[20px] mb-[30px] text-[#CBFC01]'>
          Benefits
        </h1>
        <h1 className='font-Satoshi font-bold text-[48px] mb-[30px]'>
          We have many users all over the{' '}
          <span className='text-[#CBFC01]'>world</span>
        </h1>
        <p className='font-Rubik font-normal text-[16px] text-[#ffffff70] mb-[30px]'>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam,
          purus sit amet luctus venenatis, lectus magna{' '}
        </p>
        <div className='flex text-white gap-[60px] text-center'>
          <div>
